...
export default async function CommanderPage({ searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen bg-brand-gray dark:bg-[#0A0A0B]">
      <header className="bg-white dark:bg-[#141416] border-b border-gray-100 dark:border-[#1E1E20] sticky top-0 z-40">
        <div className="max-w-lg mx-auto px-4 py-2.5 flex items-center gap-3">
          <a href="/" className="text-gray-400 hover:text-brand-red dark:hover:text-brand-red transition-colors p-1" aria-label="Retour à l'accueil">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
          </a>
          <a href="/" className="flex items-center gap-2.5 flex-1">
            <img src="/logo.png" alt="TFS" width="30" height="30" className="rounded-lg" />
            <div className="leading-tight">
              <p className="font-black text-brand-black dark:text-white text-xs tracking-wide leading-none">TAXI FAST</p>
